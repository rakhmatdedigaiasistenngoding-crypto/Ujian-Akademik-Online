-- Seed Data for PBO Exams with Packages (Variants)
...
BEGIN
  -- Bersihkan SEMUA ujian dan soal lama
  DELETE FROM public.exam_configs;
  DELETE FROM public.questions;

  -- Buat 3 Exam Config baru
  INSERT INTO public.exam_configs (id, title, duration, total_questions, distribution, score_release, max_retakes, available_from, available_until)
  VALUES 
    (v_exam_kuis, 'Kuis PBO', 10, 9, '{"easy": 3, "medium": 3, "hard": 3}'::jsonb, 'immediate', 5, NOW() - INTERVAL '1 day', NOW() + INTERVAL '7 days'),
    (v_exam_uts, 'UTS PBO', 10, 35, '{"easy": 11, "medium": 12, "hard": 12}'::jsonb, 'immediate', 5, NOW() - INTERVAL '1 day', NOW() + INTERVAL '7 days'),
    (v_exam_uas, 'UAS PBO', 10, 45, '{"easy": 15, "medium": 15, "hard": 15}'::jsonb, 'immediate', 5, NOW() - INTERVAL '1 day', NOW() + INTERVAL '7 days');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Paradigma pemrograman yang memecah suatu masalah menjadi entitas-entitas yang saling berinteraksi, dimana setiap entitas memiliki sifat dan perilaku tersendiri disebut...', '["Pemrograman Prosedural","Pemrograman Terstruktur","Pemrograman Berorientasi Objek","Pemrograman Fungsional","Pemrograman Deklaratif"]'::jsonb, 2, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Salah satu keuntungan utama menggunakan pendekatan Pemrograman Berorientasi Objek (PBO) dibandingkan prosedural adalah...', '["Program dieksekusi dari atas ke bawah tanpa percabangan","Kode lebih mudah digunakan ulang (reusable) dan dimodifikasi","Tidak membutuhkan penggunaan memori komputer","Menggabungkan semua instruksi ke dalam satu fungsi utama","Menghindari penggunaan variabel secara keseluruhan"]'::jsonb, 1, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Rancangan atau cetak biru (blueprint) yang mendefinisikan karakteristik umum dari sekumpulan objek yang sejenis disebut...', '["Method","Object","Atribut","Class","Package"]'::jsonb, 3, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Bentuk nyata (instance) dari sebuah cetak biru, yang memiliki nilai data yang spesifik dan menempati memori dalam sistem, dikenal sebagai...', '["Class","Objek","Tipe Data","Algoritma","Fungsi"]'::jsonb, 1, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Karakteristik, informasi, atau data yang membedakan satu objek dengan objek lainnya dalam kelas yang sama disebut...', '["Behavior","Method","State / Atribut","Action","Event"]'::jsonb, 2, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Tindakan, operasi, atau perilaku yang dapat dilakukan oleh sebuah objek dalam sistem disebut...', '["Identifier","Atribut","Tipe Data Dasar","Method / Behavior","Parameter"]'::jsonb, 3, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Konsep membungkus data beserta method yang mengoperasikannya ke dalam satu kesatuan, serta menyembunyikan detail internalnya dari dunia luar disebut...', '["Abstraksi","Enkapsulasi","Polimorfisme","Pewarisan","Generalisasi"]'::jsonb, 1, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Tujuan utama dari penerapan Enkapsulasi (Information Hiding) adalah...', '["Agar program berjalan lebih cepat","Mengurangi jumlah baris kode","Mencegah data diubah secara sembarangan oleh entitas lain","Memungkinkan sebuah kelas memiliki banyak bentuk","Menghapus data yang tidak lagi digunakan"]'::jsonb, 2, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Mekanisme yang memungkinkan sebuah entitas baru untuk mengambil alih atau mewarisi atribut dan method dari entitas yang sudah ada sebelumnya disebut...', '["Spesialisasi","Polimorfisme","Enkapsulasi","Inheritance (Pewarisan)","Instansiasi"]'::jsonb, 3, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Dalam konsep Pewarisan, kelas yang memberikan warisan sifat dan perilaku disebut sebagai...', '["Subclass / Child Class","Superclass / Parent Class","Abstract Class","Interface","Concrete Class"]'::jsonb, 1, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Konsep yang memungkinkan satu entitas memiliki banyak bentuk, sehingga perintah yang sama dapat menghasilkan tindakan yang berbeda tergantung pada objek yang menerimanya adalah...', '["Polimorfisme","Pewarisan Berjamak","Enkapsulasi","Generalisasi","Komposisi"]'::jsonb, 0, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Proses mendefinisikan ulang method yang diturunkan dari superclass di dalam subclass agar sesuai dengan kebutuhan spesifik subclass tersebut dikenal dengan istilah...', '["Overloading","Overriding","Hiding","Binding","Casting"]'::jsonb, 1, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Konsep PBO yang berfokus pada penyembunyian kerumitan sistem dan hanya menampilkan antarmuka fungsionalitas yang esensial kepada pengguna adalah...', '["Enkapsulasi","Polimorfisme","Abstraksi","Pewarisan","Agregasi"]'::jsonb, 2, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Hubungan "Has-A" (Memiliki) dimana suatu kelas merupakan bagian dari kelas lain, namun jika kelas utama dihancurkan, kelas bagian tersebut masih tetap bisa eksis/hidup, disebut relasi...', '["Komposisi","Agregasi","Asosiasi","Generalisasi","Spesialisasi"]'::jsonb, 1, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Hubungan "Has-A" (Memiliki) yang sangat kuat, dimana eksistensi kelas bagian sangat bergantung mutlak pada eksistensi kelas utamanya (jika induk mati, bagian juga musnah), disebut...', '["Komposisi","Agregasi","Asosiasi","Pewarisan","Realisasi"]'::jsonb, 0, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Dalam perancangan game, developer memisahkan logika pemain, logika musuh, dan logika lingkungan ke dalam entitas yang independen namun saling berkomunikasi. Hal ini menggambarkan prinsip utama dari...', '["Desain Berorientasi Objek","Desain Prosedural Murni","Desain Fungsional Bersyarat","Top-Down Programming","Bottom-Up Tanpa Entitas"]'::jsonb, 0, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Jika ''Resep Kue'' adalah sebuah Class, maka kue cokelat hasil panggangan yang ada di atas meja dan siap dimakan merupakan analogi dari...', '["Method","Atribut","Object","Identifier","Parameter"]'::jsonb, 2, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Pada sistem perpustakaan, ''Buku'' memiliki ''Judul'', ''Penulis'', dan ''Tahun Terbit''. Ketiga hal tersebut dalam PBO disebut sebagai...', '["Object","Method","Behavior","Atribut","State Transition"]'::jsonb, 3, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Mesin cuci memiliki tombol ''Mulai''. Ketika ditekan, mesin akan mengisi air, memutar tabung, dan membuang air. Pengguna tidak perlu tahu mekanisme elektroniknya. Ini adalah contoh kuat dari penerapan...', '["Polimorfisme","Inheritance","Abstraksi","Konstruktor","Variabel Lokal"]'::jsonb, 2, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Dalam sistem akademik, atribut ''IPK'' mahasiswa tidak boleh diubah secara manual dari luar kelas. IPK hanya bisa diperbarui melalui sistem perhitungan nilai akhir semester. Prinsip ini adalah bentuk dari...', '["Polimorfisme","Enkapsulasi Ketat","Abstraksi Proses","Pewarisan Berlapis","Asosiasi Kelas"]'::jsonb, 1, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Entitas ''Akun Bank'' menyediakan method khusus seperti ''cekSaldo()'', ''tarikTunai()'', dan ''setorTunai()''. Method ini digunakan agar objek lain dapat berinteraksi dengan data saldo yang disembunyikan. Method semacam ini dikenal sebagai...', '["Method Overriding","Getter dan Setter (Accessor & Mutator)","Constructor","Destructor","Abstract Method"]'::jsonb, 1, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Class ''Pegawai'' memiliki atribut ''Nama'' dan ''Gaji''. Class ''Manajer'' dan ''Staf'' mengambil atribut tersebut. Dalam hal ini, ''Pegawai'' bertindak sebagai...', '["Subclass","Object","Superclass","Interface","Package"]'::jsonb, 2, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Hewan memiliki method ''makan()''. Kucing mengimplementasikan ''makan()'' dengan memakan ikan, sedangkan Sapi mengimplementasikan ''makan()'' dengan memakan rumput. Konsep PBO apa yang sedang ditunjukkan?', '["Enkapsulasi Data","Pewarisan Berantai","Polimorfisme (Overriding)","Abstraksi Sederhana","Instansiasi Objek"]'::jsonb, 2, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Sebuah aplikasi memiliki method ''Cari(Nama)'' dan method ''Cari(NoHP)''. Meskipun namanya sama, sistem tahu mana yang harus dijalankan berdasarkan data yang dimasukkan pengguna. Ini adalah contoh dari Polimorfisme jenis...', '["Overriding","Overloading","Casting","Binding","Hiding"]'::jsonb, 1, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Pada aplikasi pengiriman pesan, terdapat kelas ''KoneksiJaringan'' yang mendefinisikan metode ''KirimData()'', namun tidak ada implementasinya sama sekali (kosong). Kelas lain yang memakainya WAJIB menjabarkan metode tersebut. Kelas ''KoneksiJaringan'' tersebut bertindak sebagai...', '["Abstract Class / Interface","Concrete Class","Object","Final Class","Sealed Class"]'::jsonb, 0, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Hubungan antara ''Dosen'' dan ''Mahasiswa'' dimana seorang Dosen mengajar banyak Mahasiswa, dan mereka saling berinteraksi secara independen tanpa bergantung eksistensi hidup-mati, disebut relasi...', '["Komposisi","Agregasi","Asosiasi","Pewarisan","Generalisasi"]'::jsonb, 2, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), '''Laboratorium Komputer'' memiliki banyak ''Komputer''. Jika Laboratorium dibongkar, Komputer-komputer tersebut masih utuh dan bisa dipindah ke ruangan lain. Hubungan ini paling tepat disebut...', '["Komposisi","Agregasi","Spesialisasi","Pewarisan","Interface"]'::jsonb, 1, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Sebuah ''Gedung'' memiliki ''Pondasi''. Jika Gedung dihancurkan rata dengan tanah, maka Pondasinya pun ikut hancur. Hubungan antara Gedung dan Pondasi adalah contoh relasi...', '["Asosiasi","Agregasi","Komposisi","Polimorfisme","Generalisasi"]'::jsonb, 2, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Karyawan A mengirimkan permohonan cuti kepada Manajer B. Dalam terminologi PBO, komunikasi atau pemanggilan method dari Objek A ke Objek B ini disebut dengan...', '["Object Instantiation","Message Passing (Pengiriman Pesan)","Data Binding","Encapsulation Flow","Dynamic Polymorphism"]'::jsonb, 1, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Pada sistem E-Commerce, kelas ''Pembayaran'' memiliki atribut ''nominal''. Kelas ''KartuKredit'' mewarisi dari ''Pembayaran''. Manakah pernyataan yang benar?', '["KartuKredit tidak memiliki atribut nominal","Pembayaran kehilangan atribut nominal setelah diwariskan","KartuKredit otomatis memiliki atribut nominal","Atribut nominal pada KartuKredit tidak bisa diubah nilainya","KartuKredit harus menghapus kelas Pembayaran terlebih dahulu"]'::jsonb, 2, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Jika Anda merancang sistem e-commerce berskala besar, memisahkan fungsionalitas ''Keranjang Belanja'', ''Manajemen Pengguna'', dan ''Proses Pembayaran'' ke dalam class yang berbeda-beda akan memberikan manfaat utama berupa...', '["Peningkatan kecepatan koneksi internet pengguna","Reusability, modularitas tinggi, dan kemudahan dalam melakukan maintenance atau debugging","Penurunan ukuran file database secara signifikan","Menghilangkan kebutuhan akan proses testing perangkat lunak","Memungkinkan program dijalankan tanpa sistem operasi"]'::jsonb, 1, 'hard', 3, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Dalam merancang kelas ''AkunBank'', seorang programmer menjadikan atribut ''Saldo'' bersifat publik (dapat diakses langsung). Risiko arsitektural terbesar dari kesalahan desain ini adalah...', '["Program tidak akan bisa di-compile sama sekali","Kelas ''''AkunBank'''' tidak bisa lagi diwariskan ke kelas lain","Integritas data terancam karena saldo bisa dimanipulasi secara ilegal oleh bagian sistem lain melewati logika validasi transaksi","Method-method di dalam kelas tersebut akan berjalan sangat lambat","Objek ''''AkunBank'''' tidak dapat diinstansiasi lebih dari satu kali"]'::jsonb, 2, 'hard', 3, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Anda memiliki class ''BentukGeometri'' dan class turunannya: ''Lingkaran'' dan ''Persegi''. Dalam program utama, Anda mengumpulkan semua objek tersebut ke dalam sebuah array bertipe ''BentukGeometri''. Ketika Anda melakukan perulangan dan memanggil fungsi ''hitungLuas()'' pada tiap elemen, sistem secara dinamis memanggil rumus yang tepat untuk masing-masing bentuk. Fenomena arsitektur ini disebut...', '["Static Binding","Dynamic Method Dispatch / Virtual Method Invocation (Polimorfisme)","Strict Encapsulation","Abstract Inheritance","Composition over Inheritance"]'::jsonb, 1, 'hard', 3, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Manakah dari skenario perancangan hierarki Pewarisan (Inheritance) berikut yang melanggar prinsip "Liskov Substitution Principle" (Subclass harus bisa menggantikan Superclass sepenuhnya)?', '["Class ''''Bebek'''' diwariskan dari class ''''Burung'''', di mana keduanya memiliki method terbang()","Class ''''MobilSport'''' diwariskan dari class ''''KendaraanRodaEmpat''''","Class ''''BujurSangkar'''' diwariskan dari class ''''PersegiPanjang'''', namun memaksakan panjang harus selalu sama dengan lebar sehingga merusak perilaku PersegiPanjang yang bebas","Class ''''KaryawanTetap'''' diwariskan dari class ''''Karyawan''''","Class ''''RekeningGiro'''' diwariskan dari class ''''RekeningBank''''"]'::jsonb, 2, 'hard', 3, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Saat merancang aplikasi Smart Home, Anda ingin memastikan bahwa BENTUK APAPUN dari perangkat pintar di masa depan (misal: Lampu, AC, MesinKopi) WAJIB memiliki fungsi ''hidupkan()'' dan ''matikan()''. Pendekatan desain PBO yang paling kokoh untuk memaksakan kontrak ini adalah...', '["Menggunakan Concrete Class sebagai induk dengan implementasi penuh","Menggunakan pola Relasi Asosiasi Ganda","Menggunakan Interface atau Class Abstract yang murni mendefinisikan kontrak tanpa implementasi detail","Menerapkan Enkapsulasi tingkat tinggi pada semua atribut perangkat","Menghindari Pewarisan dan menggunakan method Overloading di program utama"]'::jsonb, 2, 'hard', 3, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Dalam perancangan pemodelan Manusia, atribut ''Jantung'' didefinisikan di dalam konstruktor kelas ''Manusia''. Jika objek ''Manusia'' dihapus dari memori, objek ''Jantung'' secara otomatis ikut dihancurkan. Keputusan arsitektural ini mencerminkan relasi...', '["Asosiasi Bebas","Agregasi Relasional","Spesialisasi Berantai","Komposisi Kuat (Strong Composition)","Polimorfisme Statis"]'::jsonb, 3, 'hard', 3, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Developer A merancang kelas ''Pesawat'' yang mewarisi sifat dari kelas ''Burung'' hanya karena keduanya bisa terbang. Menurut prinsip analisis PBO yang baik, perancangan ini adalah...', '["Sangat efisien karena menghemat kode","Kurang tepat, karena secara konseptual Pesawat BUKANLAH sejenis Burung (melanggar relasi \"Is-A\")","Diperbolehkan asalkan menggunakan Polimorfisme","Wajib dilakukan untuk meningkatkan abstraksi","Tepat, karena PBO tidak memperdulikan logika dunia nyata"]'::jsonb, 1, 'hard', 3, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Sebuah sistem pemesanan makanan mendefinisikan kelas ''Pesanan''. Atribut ''StatusPesanan'' tidak boleh diubah kecuali urutannya: Dibuat \-\> Diproses \-\> Dikirim \-\> Selesai. Cara terbaik mengimplementasikan logika ini dalam PBO adalah...', '["Menjadikan atribut StatusPesanan publik agar mudah diubah kapan saja","Menyembunyikan atribut (private) dan membuat method seperti prosesPesanan(), kirimPesanan() yang memiliki logika validasi internal (Enkapsulasi flow)","Menghapus kelas Pesanan dan memasukkan logikanya ke database","Menggunakan overloading pada method pembuat pesanan","Menjadikan kelas Pesanan sebagai Abstract Class"]'::jsonb, 1, 'hard', 3, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Terdapat konsep ''Diamond Problem'' dalam PBO (dimana bahasa seperti Java mencegahnya dengan melarang Multiple Inheritance pada class). Konsep ini terjadi jika...', '["Sebuah kelas tidak memiliki superclass sama sekali","Sebuah kelas mewarisi dari dua atau lebih kelas induk yang memiliki method dengan nama sama, sehingga timbul ambiguitas method mana yang dipakai","Sebuah kelas memiliki jumlah atribut yang terlalu banyak","Objek dari sebuah kelas diinisiasi menggunakan pola berlian (diamond operator)","Sistem mendeteksi adanya method tanpa tipe kembalian"]'::jsonb, 1, 'hard', 3, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Pola arsitektur Model-View-Controller (MVC) sangat erat kaitannya dengan PBO. Dalam pola ini, kelas yang bertanggung jawab penuh terhadap manipulasi logika data dan validasi aturan bisnis diletakkan pada bagian...', '["Controller","View","Model","Database Routing","User Interface Layout"]'::jsonb, 2, 'hard', 3, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Pada sistem pengelolaan Universitas, seorang ''Mahasiswa'' mendaftar di banyak ''Mata Kuliah'', dan satu ''Mata Kuliah'' diikuti oleh banyak ''Mahasiswa''. Untuk memecahkan kompleksitas pemodelan "Banyak-ke-Banyak" (Many-to-Many) ini dalam PBO, solusi desain yang paling umum adalah...', '["Mewariskan Kelas Mahasiswa ke Mata Kuliah","Membuat relasi Komposisi yang saling mematikan","Membuat sebuah kelas baru (misal: ''''KRS'''' atau ''''Registrasi'''') sebagai kelas penengah (Association Class)","Menjadikan Mahasiswa dan Mata Kuliah sebagai Interface","Menghapus salah satu kelas untuk menyederhanakan sistem"]'::jsonb, 2, 'hard', 3, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Seorang analis sistem berargumen: "Daripada membuat class ''KaryawanHarian'' dan ''KaryawanBulanan'' yang mewarisi class ''Karyawan'', lebih fleksibel jika class ''Karyawan'' memiliki atribut objek ''TipePembayaran''." Pergeseran pandangan desain dari Pewarisan menjadi memiliki atribut objek ini dikenal dengan prinsip...', '["Polymorphism over Inheritance","Encapsulation over Abstraction","Composition over Inheritance (Lebih mengutamakan Komposisi dibanding Pewarisan)","Overriding over Overloading","Top-Down over Bottom-Up"]'::jsonb, 2, 'hard', 3, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Dalam konsep Pemrograman Berorientasi Objek, apabila suatu Class dirancang agar sama sekali TIDAK BISA diwariskan ke Class lain demi alasan keamanan atau integritas struktur logikanya, maka secara konseptual Class tersebut bersifat...', '["Abstrak (Abstract)","Tersegel / Final (Sealed / Final)","Publik Mutlak","Antarmuka (Interface)","Generik (Generic)"]'::jsonb, 1, 'hard', 3, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Saat merancang class ''Kendaraan'', Anda meletakkan logika validasi "Nomor Polisi harus format standar" langsung di dalam fungsi ''setter'' atribut Nomor Polisi. Ini memastikan bahwa...', '["Tidak ada objek Kendaraan yang memiliki Nomor Polisi tidak valid selama program berjalan (Integritas Objek via Enkapsulasi)","Program akan berjalan lebih cepat dibanding tanpa validasi","Class Kendaraan tidak dapat diturunkan ke kelas lain","Memori yang digunakan akan berkurang drastis","Nomor polisi tersebut dapat langsung mencetak dirinya sendiri ke layar"]'::jsonb, 0, 'hard', 3, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Dalam PBO tingkat lanjut, penggunaan Dependency Injection (menyuntikkan objek ke dalam kelas melalui konstruktor) digunakan untuk...', '["Membuat ketergantungan antar kelas menjadi sangat kuat dan tidak bisa diubah (Tight Coupling)","Mengurangi keterkaitan yang kaku antar kelas (Loose Coupling) sehingga kelas lebih mudah dites dan dipelihara","Menghancurkan objek yang sudah tidak terpakai","Meningkatkan keamanan data dengan menyembunyikan atribut","Menghentikan pewarisan (Inheritance) secara total dalam proyek"]'::jsonb, 1, 'hard', 3, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Sifat atau keadaan dari sebuah objek yang merepresentasikan nilainya pada suatu saat tertentu disebut...', '["Behavior","Identity","State / Kondisi","Method","Event"]'::jsonb, 2, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Kemampuan untuk membuat kelas baru yang secara otomatis mempertahankan karakteristik dari kelas yang sudah ada disebut...', '["Polymorphism","Inheritance (Pewarisan)","Encapsulation","Abstraction","Composition"]'::jsonb, 1, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Sekumpulan objek yang memiliki atribut, perilaku, dan relasi yang serupa dikelompokkan dalam satu entitas konseptual yang dinamakan...', '["Package","Array","Class","Method","Variable"]'::jsonb, 2, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Proses menyembunyikan detail implementasi rumit dari suatu sistem dan hanya menampilkan fungsionalitas utamanya kepada pengguna disebut...', '["Encapsulation","Abstraction","Polymorphism","Inheritance","Overloading"]'::jsonb, 1, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Relasi berjenis "Is-A" (Adalah Sebuah) dalam pemodelan PBO paling tepat merujuk pada konsep...', '["Asosiasi","Agregasi","Komposisi","Pewarisan (Inheritance)","Enkapsulasi"]'::jsonb, 3, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Dalam PBO, fungsi, prosedur, atau rutin yang melekat pada sebuah kelas dan mendefinisikan apa yang bisa dilakukan oleh objek disebut...', '["Atribut","Objek","Method","Variabel","Parameter"]'::jsonb, 2, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Penggunaan dua atau lebih metode dengan nama yang sama di dalam satu kelas, asalkan memiliki parameter (signature) yang berbeda, disebut...', '["Overriding","Overloading","Polymorphism Dinamis","Encapsulation","Inheritance"]'::jsonb, 1, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Modifier (pembatas) hak akses yang memastikan suatu atribut atau metode HANYA DAPAT diakses oleh kelas itu sendiri adalah...', '["Public","Private","Protected","Default","Global"]'::jsonb, 1, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Relasi mendasar antar kelas di mana satu kelas menggunakan fungsionalitas kelas lain secara independen, tanpa ikatan siklus hidup yang kuat, dinamakan...', '["Asosiasi","Komposisi","Pewarisan","Abstraksi","Enkapsulasi"]'::jsonb, 0, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Ketika sebuah objek dari kelas turunan (subclass) diolah atau diperlakukan seolah-olah ia adalah objek dari kelas induknya (superclass), sistem ini menerapkan prinsip...', '["Encapsulation","Abstraction","Polymorphism","Instantiation","Aggregation"]'::jsonb, 2, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Dalam rancangan kelas ''Mobil'', entitas seperti ''warna'', ''merk'', dan ''kecepatanMaksimal'' dikategorikan sebagai...', '["Method","Behavior","Atribut","Class","Object"]'::jsonb, 2, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Sedangkan entitas seperti ''hidupkanMesin()'', ''tambahKecepatan()'', dan ''rem()'' dalam kelas ''Mobil'' dikategorikan sebagai...', '["Atribut","Method","Class","State","Objek"]'::jsonb, 1, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Manakah dari daftar berikut ini yang BUKAN merupakan prinsip/pilar dasar dari Pemrograman Berorientasi Objek?', '["Encapsulation","Inheritance","Polymorphism","Compilation","Abstraction"]'::jsonb, 3, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Fungsi khusus di dalam sebuah kelas yang bertugas mempersiapkan memori dan secara otomatis dijalankan setiap kali sebuah objek baru diciptakan disebut...', '["Destructor","Setter","Getter","Constructor (Konstruktor)","Overrider"]'::jsonb, 3, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Memberikan nilai default/awal pada atribut saat sebuah objek pertama kali "lahir" ke dalam sistem adalah tanggung jawab utama dari fitur PBO berupa...', '["Konstruktor","Enkapsulasi","Pewarisan","Polimorfisme","Garbage Collector"]'::jsonb, 0, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Analogi: Jika ''Cetakan Kue'' adalah sebuah Class, dan ''Kue Bolu'' adalah Objek, maka rasa cokelat atau ukuran diameter 20cm pada kue tersebut melambangkan...', '["Method","Behavior","Atribut","Constructor","Abstraction"]'::jsonb, 2, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Pada aplikasi HRD, atribut ''gajiPegawai'' diberi hak akses Private. Nilainya hanya bisa diakses menggunakan metode khusus getGaji(). Tujuan utama arsitektur ini adalah...', '["Meningkatkan kecepatan eksekusi program","Menghindari duplikasi kode","Melindungi integritas data gaji dari manipulasi sembarangan pihak luar (Enkapsulasi)","Memungkinkan perhitungan komputasi cloud","Menerapkan pewarisan ganda"]'::jsonb, 2, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Class ''Unggas'' memiliki method ''bergerak()''. Class ''Burung'' (turunan Unggas) memodifikasi method tersebut menjadi ''terbang()'', sedangkan ''Ayam'' (turunan Unggas) memodifikasinya menjadi ''berjalan()''. Proses mendefinisikan ulang method ini disebut...', '["Method Overloading","Method Overriding","Object Instantiation","Data Abstraction","Structural Composition"]'::jsonb, 1, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Anda mendesain kelas ''Perpustakaan'' yang memuat banyak ''Buku''. Jika ''Perpustakaan'' ditutup/dibongkar, fisik ''Buku'' tersebut tetap utuh dan bisa dipindahkan ke perpustakaan lain. Dalam UML, relasi ini dikenal sebagai...', '["Komposisi","Agregasi","Generalisasi","Spesialisasi","Pewarisan"]'::jsonb, 1, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Sebaliknya, Anda merancang kelas ''Manusia'' dan ''Jantung''. Jantung dikonstruksi bersamaan dengan manusia. Jika manusia tersebut wafat/hancur, jantung tersebut juga berhenti eksis sebagai organ fungsional. Relasi yang mengikat mutlak ini adalah...', '["Komposisi","Agregasi","Asosiasi Bebas","Generalisasi","Polymorphism"]'::jsonb, 0, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Sistem kasir toko menyediakan dua fungsi diskon. Fungsi pertama: hitungDiskon(NamaPelanggan). Fungsi kedua: hitungDiskon(NamaPelanggan, KartuMember). Sistem tidak bingung karena mengenali beda jumlah parameternya. Ini adalah bentuk penerapan...', '["Method Overriding","Method Overloading","Secure Encapsulation","Abstract Logic","Inheritance Link"]'::jsonb, 1, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Dalam sistem kampus, class ''Dosen'' dan ''Mahasiswa'' memiliki kesamaan atribut seperti ''Nama'', ''Alamat'', dan ''NoTelp''. Untuk mencegah kode ditulis berulang-ulang, desain PBO yang efisien adalah...', '["Membuat sebuah class ''''CivitasAkademika'''' (atau ''''Person'''') sebagai Superclass bagi keduanya","Menyatukan dosen dan mahasiswa secara paksa di dalam satu class","Membuat Dosen menjadi subclass dari Mahasiswa","Menerapkan Enkapsulasi penuh tanpa Pewarisan","Mematikan fitur atribut pada kedua kelas"]'::jsonb, 0, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Satu tombol ''Play'' pada sistem home theater bisa memutar kaset, membaca CD, atau menyetel Bluetooth MP3. Sistem di dalamnya menavigasi perilaku perangkat baca yang tepat secara otomatis. Prinsip PBO ini merupakan implementasi sejati dari...', '["Inheritance","Encapsulation","Polymorphism","Static Typed","Constructor Default"]'::jsonb, 2, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Pada game catur, class ''BidakCatur'' memiliki metode ''bergerak()''. Namun BidakCatur hanyalah konsep, tidak ada bidak nyata yang bernama murni "BidakCatur" (semua bidak adalah Pion, Kuda, dll). Secara perancangan PBO, metode ''bergerak()'' di kelas induk harus dibuat sebagai...', '["Concrete Method","Abstract Method","Final Method","Private Method","Overloaded Method"]'::jsonb, 1, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Sebuah kucing adalah sejenis hewan (Kucing Is-A Hewan). Jika dalam sistem referensi variabel bertipe ''Hewan'' menunjuk pada objek ''Kucing'' di memori, kita sedang memanfaatkan kemampuan PBO yaitu...', '["Enkapsulasi State","Polimorfisme (Upcasting)","Data Hiding","Asosiasi","Agregasi Parsial"]'::jsonb, 1, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Jika Anda merancang kelas ''Lingkaran'', secara rasional matematis atribut ''jari\_jari'' tidak boleh bernilai negatif. Validasi pencegahan angka negatif paling tepat ditempatkan pada...', '["Superclass Lingkaran","Method Getter","Method Setter / Konstruktor","Abstract Class","Interface Publik"]'::jsonb, 2, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Saat mengemudikan mobil, Anda cukup menginjak pedal rem dan laju mobil melambat. Anda tidak tahu dan tidak perlu tahu perhitungan gesekan kampas rem di dalam ban. Filosofi desain "sembunyikan cara kerjanya, tampilkan cara pakainya" ini adalah wujud nyata dari...', '["Polimorfisme Dinamis","Abstraksi Fungsional","Pewarisan Berjamak","Relasi Agregasi","Overloading Parametrik"]'::jsonb, 1, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Mobil dirangkai dari Bodi, Mesin, dan Roda. Hubungan konseptual yang menyatakan "Mobil memiliki Roda" (Mobil Has-A Roda) di dalam pemodelan PBO mewakili ikatan...', '["Generalisasi","Relasi Asosiasi / Agregasi / Komposisi","Spesialisasi","Pewarisan Berjamak","Polimorfisme Dinamis"]'::jsonb, 1, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Mesin ATM tidak membiarkan Anda mengakses tabel database secara mandiri. Ia menengahi transaksi menggunakan layar antarmuka TarikDana(). Dalam konsep OOP, ini adalah bentuk praktis penerapan...', '["Enkapsulasi","Polimorfisme","Pewarisan Terbuka","Overloading Instans","Abstraksi Murni"]'::jsonb, 0, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Dalam ilmu biologi, ''Penguin'' diwarisi dari famili ''Burung''. Tapi jika kelas ''Burung'' memiliki fungsionalitas baku ''bisa\_terbang()'', mewariskan kelas ''Burung'' ke kelas ''Penguin'' dalam sistem perangkat lunak akan mengakibatkan...', '["Penguin otomatis bisa terbang tanpa error","Kecacatan logika sistem karena memaksakan sifat yang tidak wajar (melanggar model desain dunia nyata yang spesifik)","Sistem menjadi hemat memori","Polimorfisme bekerja lebih maksimal","Kode menjadi sangat ringkas"]'::jsonb, 1, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Dalam metodologi arsitektur sistem berskala besar berbasis PBO, memisahkan logika tata letak tampilan (GUI) dari manipulasi algoritma basis data diimplementasikan secara efisien melalui design pattern (pola desain) standar industri yaitu...', '["Singleton Pattern","Model-View-Controller (MVC) Pattern","Observer Pattern","Decorator Pattern","Factory Pattern"]'::jsonb, 1, 'hard', 3, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Beberapa bahasa pemrograman PBO modern dengan ketat melarang konsep Multiple Inheritance (satu kelas anak mewarisi atribut dua kelas induk sekaligus). Alasan arsitektural di balik larangan ini adalah...', '["Terlalu banyak menggunakan RAM komputer klien","Untuk menghindari \"Diamond Problem\", yakni kebingungan kompilator saat dua kelas induk memiliki nama metode identik","Mencegah penggunaan variabel statis","Menghapus fungsionalitas dari Konstruktor asli","Membatasi fleksibilitas programmer secara disengaja"]'::jsonb, 1, 'hard', 3, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Sebagai jalan tengah untuk menghindari Multiple Inheritance, PBO menyediakan fitur agar sebuah class dapat "menandatangani kontrak" untuk mematuhi banyak standar metode terstruktur melalui penggunaan...', '["Abstract Superclass","Antarmuka (Interface)","Polimorfisme Rekursif","Variabel Dinamis","Concrete Composition"]'::jsonb, 1, 'hard', 3, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Dalam perangkat lunak pemesanan tiket penerbangan multithread (banyak pelanggan memesan bersamaan), atribut ''sisaKursi'' dibungkus rapat-rapat dan pengurangannya hanya dapat dilakukan satu per satu via metode terkontrol. Landasan pengamanan arsitektur ini berdiri di atas prinsip...', '["Abstraksi Visual","Generalisasi Penuh","Enkapsulasi / Penyembunyian Data Tingkat Lanjut","Agregasi Relasional","Polimorfisme Berlapis"]'::jsonb, 2, 'hard', 3, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Prinsip arsitektur PBO yang terkenal, "Composition over Inheritance" (Lebih memprioritaskan Komposisi dibanding Pewarisan) berargumen bahwa...', '["Pewarisan tidak berguna dan harus dihapus","Lebih menguntungkan membangun fitur dengan merangkai kelas-kelas independen seperti blok lego, daripada menciptakan silsilah keluarga (inheritance) hierarkis yang kaku dan rentan patah","Pewarisan selalu memicu sistem error secara runtime","Atribut public selalu lebih aman daripada atribut protected","Metode Overloading hanya bisa dicapai melalui komposisi mutlak"]'::jsonb, 1, 'hard', 3, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Jika Anda memiliki array kumpulan ''Pegawai'', yang berisi ''Manajer'', ''Staf'', dan ''Direktur''. Anda melakukan iterasi/looping dan memanggil perintah ''hitungBonus()''. Sistem otomatis memberikan 50% untuk Direktur dan 10% untuk Staf di saat runtime (saat aplikasi jalan). Kecerdasan mesin mengenali tipe objek aslinya ini ditangani oleh fitur...', '["Static Binding","Dynamic Method Dispatch (Virtual Method Invocation) / Late Binding","Encapsulation Parsing","Structural Abstraction","Composition Linkage"]'::jsonb, 1, 'hard', 3, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Dalam pembuatan game engine, class inti ''GameObject'' memiliki deklarasi ''render()'' abstrak. Segala elemen di layar (Peluru, Karakter, Pohon) wajib mewarisi GameObject dan wajib menjabarkan cara ''render()'' mereka sendiri. Manfaat masif dari desain struktural ini adalah...', '["Game engine tidak perlu menyeleksi objek menggunakan logika IF/ELSE yang panjang, cukup memanggil ''''render()'''' polimorfik secara merata","Peluru bisa mengubah tipenya menjadi pohon secara dinamis","Memori grafis tidak terpakai sama sekali","Metode render tidak perlu ditulis di anak kelas","Mengurangi kecepatan eksekusi logika game"]'::jsonb, 0, 'hard', 3, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Sebuah class inti penyandi password (EncryptionService) dikunci secara arsitektural menggunakan modifier Final (atau Sealed) sehingga ia tidak bisa dijadikan Superclass sama sekali. Apa justifikasi logis untuk mengunci class ini?', '["Agar proses enkripsi berjalan sangat cepat menembus perangkat keras","Mencegah programmer lain membuat subclass yang sengaja ''''merusak'''' atau membocorkan mekanisme algoritma enkripsi internal demi keamanan tinggi","Supaya class tersebut bisa menjadi interface ganda","Meringankan beban kompilator bahasa","Mengizinkan class tersebut dihapus saat runtime"]'::jsonb, 1, 'hard', 3, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Pada pemodelan hubungan "Rumah Sakit" dan "Dokter" (Agregasi) dibandingkan "Rumah Sakit" dan "Ruang UGD" (Komposisi). Perbedaan utama penulisan abstraksinya dalam desain arsitektur Object Oriented terletak pada...', '["Jumlah parameter di setiap metode","Dependensi siklus hidup (Lifecycle Dependency): di komposisi, \"Ruang UGD\" harus dimusnahkan jika \"Rumah Sakit\" dihancurkan; sementara \"Dokter\" akan tetap eksis meski rumah sakitnya tutup","Penggunaan method overriding","Kemampuan enkapsulasi objek turunan","Keberadaan atribut publik"]'::jsonb, 1, 'hard', 3, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Developer merancang kelas ''Persegi'' yang mewarisi sifat ''PersegiPanjang''. Masalah muncul jika di program utama (Main), method bawaan mengubah ''lebar'' persegi tersebut tanpa mengubah ''panjang'', mematahkan kaidah geometri persegi secara tak sengaja. Kesalahan pewarisan logika PBO ini adalah pelanggaran terhadap...', '["Liskov Substitution Principle (LSP)","Interface Segregation Principle (ISP)","Single Responsibility Principle (SRP)","Dependency Inversion Principle (DIP)","Open/Closed Principle (OCP)"]'::jsonb, 0, 'hard', 3, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Salah satu kekuatan Polimorfisme adalah membuat aplikasi ''Scalable'' (Mudah Berkembang). Ini dapat tercapai utamanya karena...', '["Penambahan objek turunan baru di masa depan tidak mengharuskan developer mengubah ulang logika pemanggil inti yang bergantung pada kelas induknya","Aplikasi bisa dirubah menjadi prosedur struktural sewaktu-waktu","Fitur kompresi kode bekerja maksimal memperkecil file instalasi","Mengurangi penggunaan memori pada perangkat berspesifikasi rendah","Semua error dapat diperbaiki sendiri oleh compiler"]'::jsonb, 0, 'hard', 3, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Class Diagram pada dokumen perancangan menunjukkan "Relasi Asosiasi Ganda" (Bidirectional Association) antara ''Pembeli'' dan ''Toko''. Translasi yang tepat ke logika PBO adalah...', '["Keduanya disatukan secara paksa ke satu entitas mega-class","Pembeli menyimpan referensi ke Toko, dan Toko menyimpan referensi koleksi Pembeli, keduanya saling tahu satu sama lain","Pembeli mewarisi dari Toko","Toko mewarisi sifat Pembeli","Pembeli hanya menggunakan Toko sebagai variabel lokal sesaat"]'::jsonb, 1, 'hard', 3, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Seorang arsitek software mendesain fungsi pembuat laporan \*cetak()\*. Daripada memusingkan rekan setimnya dengan puluhan nama seperti \*cetakKePDF()\*, \*cetakKeWord()\*, \*cetakKeExcel()\*, ia menggunakan \*cetak(PDF)\*, \*cetak(Word)\*. Pendekatan menyatukan nama logika fungsional ini difasilitasi oleh...', '["Abstraksi Struktural Bebas","Polimorfisme Statis / Method Overloading","Overriding Instans","Enkapsulasi Flow","Komposisi Tingkat Dasar"]'::jsonb, 1, 'hard', 3, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Perbedaan paling substansial dalam perancangan sistem antara Abstract Class dan Interface adalah...', '["Interface di PBO modern boleh memiliki nilai atribut yang berubah-ubah","Interface mendefinisikan murni \"Kontrak Kemampuan\" (Apa yang bisa dilakukannya), sedangkan Abstract Class mendefinisikan \"Identitas Inti\" (Siapa dia sebenarnya) plus membagikan fungsionalitas turunan utamanya","Abstract class berjalan lebih cepat","Interface tidak mendukung polimorfisme","Abstract class mencegah pewarisan"]'::jsonb, 1, 'hard', 3, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Dalam pola desain arsitektur standar industri OOP (Design Patterns), ada kalanya sebuah class koneksi database dikonfigurasi menggunakan struktur Singleton. Artinya class tersebut dirancang untuk...', '["Selalu diwariskan oleh seluruh form GUI","Mengandung constructor dengan akses public total","Memastikan hanya ada MAKSIMAL SATU objek (instance) utuh dari kelas tersebut yang aktif mengatur lalu lintas data selama program berjalan, menghindari tabrakan trafik","Menyembunyikan keseluruhan fungsionalitas database dari sistem pengguna","Memusnahkan dirinya sendiri setelah dipanggil tiga kali"]'::jsonb, 2, 'hard', 3, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Dalam PBO, prinsip "Information Hiding" (menyembunyikan informasi internal) merupakan gagasan inti dari konsep...', '["Polimorfisme","Pewarisan","Enkapsulasi","Abstraksi","Asosiasi"]'::jsonb, 2, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Proses merepresentasikan atau memodelkan entitas dunia nyata ke dalam bentuk cetak biru perangkat lunak dengan hanya mengambil fitur-fitur yang esensial disebut...', '["Enkapsulasi","Abstraksi","Polimorfisme","Komposisi","Instansiasi"]'::jsonb, 1, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Di dalam pemodelan visual seperti UML (Unified Modeling Language), relasi ''Pewarisan'' (Inheritance) umumnya digambarkan menggunakan simbol...', '["Panah putus-putus","Garis dengan bidang belah ketupat hitam","Garis dengan bidang belah ketupat putih","Garis lurus biasa","Garis berujung panah dengan segitiga kosong/putih"]'::jsonb, 4, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Hubungan struktural di mana dua kelas saling terhubung, saling berkomunikasi, dan saling menggunakan fungsi satu sama lain tanpa ketergantungan hidup-mati disebut relasi...', '["Asosiasi","Pewarisan","Spesialisasi","Komposisi","Enkapsulasi"]'::jsonb, 0, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Entitas utama pada program berorientasi objek yang menampung data (state) sekaligus fungsi untuk memanipulasi data tersebut dinamakan...', '["Variabel","Method","Objek","Array","Pointer"]'::jsonb, 2, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Untuk mengubah nilai suatu atribut yang bersifat tersembunyi (private), praktik terbaik (best practice) dalam PBO adalah menggunakan...', '["Method Getter","Method Setter","Konstruktor Abstrak","Variabel Global","Modifier Public secara langsung"]'::jsonb, 1, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Sebaliknya, untuk mengambil atau membaca nilai suatu atribut yang bersifat private, praktik terbaik dalam PBO adalah menggunakan...', '["Method Getter","Method Setter","Polimorfisme","Abstraksi Data","Akses Array"]'::jsonb, 0, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Karakteristik OOP yang memungkinkan objek-objek yang berbeda dapat merespon perintah (pemanggilan method) yang namanya sama dengan tindakan yang berbeda-beda disebut...', '["Pewarisan","Generalisasi","Abstraksi","Polimorfisme","Enkapsulasi"]'::jsonb, 3, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Sebuah kelas yang sengaja dirancang agar TIDAK DAPAT dibuatkan objek nyatanya (tidak dapat diinstansiasi) dan hanya berfungsi sebagai kerangka dasar dinamakan...', '["Kelas Konkret","Kelas Abstrak","Interface Murni","Kelas Final","Kelas Statis"]'::jsonb, 1, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Atribut/variabel yang kepemilikannya bukan pada objek individual, melainkan dimiliki bersama oleh satu kelas itu sendiri secara utuh, disebut sebagai variabel...', '["Lokal","Instans","Statis (Class Variable)","Dinamis","Konstruktor"]'::jsonb, 2, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Sebuah deklarasi metode di dalam kelas yang hanya memiliki nama fungsi tanpa memiliki body (isi implementasi) sama sekali dinamakan...', '["Method Abstrak","Method Overloading","Method Final","Method Private","Method Konstruktor"]'::jsonb, 0, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Prinsip dalam OOP yang menyatakan bahwa kelas anak (subclass) harus mewarisi dan dapat memiliki seluruh fungsionalitas dari kelas induknya (superclass) adalah...', '["Agregasi","Komposisi","Pewarisan (Inheritance)","Abstraksi","Interface"]'::jsonb, 2, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Manakah istilah yang merujuk pada penulisan beberapa fungsi dengan nama yang persis sama di dalam SATU kelas, namun dibedakan berdasarkan jumlah atau tipe parameternya?', '["Method Overriding","Method Overloading","Method Hiding","Method Abstracting","Method Invoking"]'::jsonb, 1, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Manakah istilah yang merujuk pada penulisan ulang/penggantian implementasi fungsi yang berasal dari superclass ke dalam subclass-nya?', '["Method Overriding","Method Overloading","Method Calling","Method Setting","Method Overlapping"]'::jsonb, 0, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Dalam pemahaman objek, kondisi internal (state) dari suatu objek pada waktu tertentu ditentukan sepenuhnya oleh...', '["Nama dari metode yang dimilikinya","Kelas induk yang menurunkannya","Nilai-nilai yang tersimpan di dalam atribut-atributnya","Letak objek di dalam memori komputer","Relasinya dengan objek antarmuka"]'::jsonb, 2, 'easy', 1, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Pada game RPG, karakter Penyihir dan Ksatria diwarisi dari class Karakter. Keduanya memiliki fungsi ''serang()''. Penyihir menembakkan bola api, Ksatria mengayunkan pedang. Fenomena fungsionalitas ini adalah contoh nyata dari penerapan...', '["Polimorfisme","Enkapsulasi","Abstraksi Dinamis","Relasi Asosiasi","Agregasi Parsial"]'::jsonb, 0, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Saat merancang aplikasi perbankan, atribut ''saldo'' diatur agar disembunyikan dan hanya bisa diakses via metode \`setor()\` dan \`tarik()\`. Hal ini mencerminkan prinsip arsitektur...', '["Generalisasi Pewarisan","Enkapsulasi / Information Hiding","Polimorfisme Statis","Class Abstraction","Object Destruction"]'::jsonb, 1, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Seorang ''Dosen'' memiliki sekumpulan objek ''Mahasiswa'' Bimbingan. Dosen tersebut bisa saja pensiun, tetapi Mahasiswa tetap bisa dibimbing oleh dosen lain (keduanya tetap utuh hidup). Ini adalah bentuk relasi...', '["Komposisi","Agregasi","Pewarisan","Instansiasi","Spesialisasi"]'::jsonb, 1, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Sistem memproses entitas ''Bentuk'' pada layar. Namun, program tidak pernah membuat objek nyata dari ''Bentuk'', melainkan langsung membuat ''Segitiga'' atau ''Lingkaran''. Secara konsep struktural, kelas ''Bentuk'' difungsikan sebagai...', '["Kelas Instans (Concrete Class)","Kelas Abstrak (Abstract Class)","Kelas Final (Sealed Class)","Kelas Anak (Subclass)","Kelas Statis (Static Class)"]'::jsonb, 1, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Dalam kelas ''Mobil'', fungsi \`nyalakanMesin()\` dapat dipanggil menggunakan parameter input berupa objek (KunciFisik), ATAU dapat dipanggil menggunakan parameter (KodeDigital). Penerapan pemanggilan fleksibel ini terjadi karena teknik...', '["Method Overriding","Method Overloading","Data Hiding","Polimorfisme Objek","Class Composition"]'::jsonb, 1, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Sebuah ''Sistem Akuntansi'' memerlukan algoritma kompleks perhitungan pajak bulanan. Fungsi perhitungan ini diletakkan tertutup dalam kelas khusus tanpa bisa dipanggil oleh komponen antarmuka layar pengguna secara mandiri. Konsep yang diterapkan adalah...', '["Enkapsulasi Proses / Black Box","Pewarisan Berjamak","Polimorfisme Dinamis","Konstruktor Bebas","Agregasi Bebas"]'::jsonb, 0, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Buku memiliki banyak Halaman. Jika fisik Buku dibakar, maka seluruh Halaman di dalamnya dipastikan ikut musnah. Dalam PBO, relasi ini paling cocok diimplementasikan menggunakan konsep...', '["Agregasi","Asosiasi Bebas","Komposisi","Pewarisan Rantai","Generalisasi"]'::jsonb, 2, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Karyawan merupakan superclass. Manager mewarisi Karyawan. Jika kita membuat array khusus bertipe data Karyawan, namun kita memasukkan objek Manager ke dalam slot array tersebut, kemampuan sistem menoleransi hal ini disebut...', '["Polimorfisme Upcasting","Polimorfisme Downcasting","Enkapsulasi Konstruktor","Abstraksi Tingkat Rendah","Multiple Inheritance"]'::jsonb, 0, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Jika metode standar \`bernafas()\` di kelas Mamalia ditulis ulang logikanya di kelas Paus agar sesuai dengan mekanisme cara paus bernafas (harus muncul ke permukaan air), teknik ini dinamakan...', '["Method Hiding","Method Calling","Method Overloading","Method Overriding","Method Abstrak"]'::jsonb, 3, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Objek ''RemoteAC'' memiliki tombol pengatur suhu. Pengguna hanya menekan tombol tanpa perlu tahu rumitnya sirkuit kelistrikan pemancar sinyal infra-merah di dalamnya. Ini menunjukkan prinsip kemudahan penggunaan OOP yang disebut...', '["Pewarisan (Inheritance)","Abstraksi (Abstraction)","Asosiasi (Association)","Konstruksi Objek (Construction)","Setter Statis"]'::jsonb, 1, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Anda membuat kelas konseptual Kendaraan dengan metode abstrak bergerak(). Anda tidak bisa menggunakan syntax pembuatan objek "New Kendaraan()" di memori komputer karena...', '["Memori komputer tidak akan cukup menampung benda abstrak","Kelas abstrak hanya bertindak sebagai cetak biru konseptual tak berwujud bagi turunannya","Method bergerak harus dihapus terlebih dahulu","Kendaraan bersifat final","Kompiler akan bingung menentukan ukurannya"]'::jsonb, 1, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Dalam sistem manajemen perpustakaan, ''Anggota'' dapat meminjam banyak ''Buku'', dan ''Buku'' dapat dipinjam oleh ''Anggota'' secara bergantian sepanjang tahun. Hubungan struktural yang saling mengenali secara independen ini disebut...', '["Komposisi","Spesialisasi","Asosiasi","Generalisasi","Enkapsulasi"]'::jsonb, 2, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Apa yang akan terjadi menurut aturan OOP jika sebuah kelas turunan (subclass) mencoba mengambil dan mengubah atribut yang diset ''private'' dari kelas induknya secara brutal tanpa menggunakan metode perantara getter/setter?', '["Atribut akan otomatis berubah menjadi publik","Subclass tersebut otomatis memutus ikatan pewarisan","Terjadi pelanggaran hak akses (Akses ditolak / Error)","Sistem akan membiarkannya demi polimorfisme","Nilai atribut akan terhapus"]'::jsonb, 2, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Ketika menganalisa sistem, Anda menemukan entitas Pelanggan dan Pemasok sama-sama memiliki atribut ''Nama'', ''Alamat'', dan ''No\_Telp''. Langkah refactoring OOP paling optimal adalah...', '["Menyatukan Pemasok dan Pelanggan menjadi satu kelas paksa","Membuat superclass baru (misal: EntitasBisnis) yang memuat atribut tersebut, lalu diwariskan ke keduanya","Menghapus atribut di Pelanggan agar menghemat memori","Membuat Pelanggan menjadi subclass dari Pemasok","Membuat class Pelanggan dan Pemasok menjadi class abstrak"]'::jsonb, 1, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Anda membuat metode \`hitungGaji()\` tanpa implementasi (kosong) di dalam Antarmuka (Interface) Pegawai. Antarmuka tersebut kemudian diimplementasikan oleh kelas PegawaiTetap dan PegawaiKontrak. Manfaat utamanya adalah...', '["Menjamin sistem bisa menghapus kelas pegawai dengan mudah","Menjamin bahwa apapun jenis pegawainya kelak, PASTI memiliki kemampuan untuk menghitung gaji (Kontrak standar)","Membuat kelas pegawai menjadi error","Mengurangi kebutuhan memori sistem hingga 50%","Mencegah penggunaan constructor"]'::jsonb, 1, 'medium', 2, 'PBO');

  INSERT INTO public.questions (id, text, options, correct_answer, level, weight, topic)
  VALUES (gen_random_uuid(), 'Dalam dunia rekayasa perangkat lunak modern, para arsitek sering memprioritaskan prinsip "Komposisi dibandingkan Pewarisan" (Composition over Inheritance). Alasan utama kelemahan arsitektur pewarisan yang berantai terlalu dalam adalah...', '["Terlalu memakan banyak kapasitas disk (Storage)","Mengharuskan penggunaan variabel global berlebihan","Menyebabkan masalah ''''Fragile Base Class'''' di mana sistem menjadi kaku dan setiap perubahan kecil di superclass dapat merusak seluruh fungsionalitas subclass di bawahnya secara tidak terduga","Mewajibkan penghapusan fungsi Polimorfisme dari bahasa pemrograman","Kelas induk akan otomatis hancur saat kelas anak dibuat"]'::jsonb, 2, 'hard', 3, 'PBO');
